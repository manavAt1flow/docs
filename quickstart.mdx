...
description: 'Get started with the Tuesday Public APIs in under 5 minutes'
---

## Get Your API Key

To get started with the Tuesday Public APIs, you'll need an API key:
...
<CardGroup cols={2}>
  ...
  <Card title="Support" icon="envelope" href="mailto:support@tuesday.so">
