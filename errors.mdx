...
The Tuesday Public APIs use standard HTTP status codes to indicate the success or failure of API requests. When an error occurs, the response will include a structured error message to help you understand and resolve the issue.
...
<CardGroup cols={2}>
  ...
  <Card title="Contact Support" icon="envelope" href="mailto:support@tuesday.so">
